...
public class OI {
    ...
    public OI() {
        ...
        setElevatorPosition1.whenPressed(new SetElevatorMode(true));
        setElevatorPosition1.whileHeld(new ElevatorMoveToPosition(22.0));	// Button 5 puts the right arm in the large position
 
        setElevatorPosition3 = new JoystickButton(operatorJoystick, 10);	// Button 5 puts the right arm in the large position
        setElevatorPosition1.whenPressed(new SetElevatorMode(true));
        setElevatorPosition1.whileHeld(new ElevatorMoveToPosition(33.5));	// Button 5 puts the right arm in the large position

        setElevatorPosition3 = new JoystickButton(operatorJoystick, 11);	// Button 5 puts the right arm in the large position
        setElevatorPosition1.whenPressed(new SetElevatorMode(true));
        setElevatorPosition1.whileHeld(new ElevatorMoveToPosition(45.0));
